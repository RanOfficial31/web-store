...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="hubungi.php" class="nav-item nav-link">Hubungi</a>
                </div>
            </div>
        </nav>
                        ...
                        <div class="team-img position-relative overflow-hidden">
                            ...
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle"
                                    href="produk.php?categori=Pakaian Pria"><i
                ...
                <div class=" wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden" style="box-shadow: 8px 8px 8px #cbced1;">
                        <div class="team-img position-relative overflow-hidden">
                            ...
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle"
                                    href="produk.php?categori=Pakaian Wanita"><i
                                        class="bi bi-eye-fill w-12 h-12 fw-normal"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                ...
                <div class=" wow slideInUp" data-wow-delay="0.9s">
                    <div class="team-item bg-light rounded overflow-hidden" style="box-shadow: 8px 8px 8px #cbced1;">
                        <div class="team-img position-relative overflow-hidden">
                            ...
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle"
                                    href="produk.php?categori=Pakaian Anak"><i
                                        class="bi bi-eye-fill w-12 h-12 fw-normal"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                                    ...
                                    <a href="produk-detail.php?nama=<?php echo $data['nama']; ?>">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <a class="text-uppercase"
                                                href="produk-detail.php?nama=<?php echo $data['nama']; ?>">Lihat
    ...
    <div class="d-flex align-items-center justify-content-center wow zoomIn" data-wow-delay="0.6s">
        <a href="Produk.php" class="btn btn-primary py-3 px-5" style="box-shadow: 4px 4px 4px #b1b1b1">Lihat
            Semua Produk</a>
    </div>
    <!-- Product End -->
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function sendEmail(name, email, phone, message) {
                Email.send({
                    ...
                    message => swal("success!", "Pesan Anda Berhasil Terkirim!", "success")
                );
            }
        });
    </script>
