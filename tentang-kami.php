        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="tentang-kami.php" class="nav-item nav-link active">Tentang Kami</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <a href="hubungi.php" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn"
                ...
                <div class="col-lg-7">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex rounded overflow-hidden mb-3">
                            ...
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">Ran Official
                            </a>
                        </div>
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="img/mail.png" style="width: 60px; height: 60px; object-fit: cover;" alt="">
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">ranofficial97@gmail.com
                            </a>
                        </div>
                        <div class="d-flex rounded overflow-hidden mb-3">
