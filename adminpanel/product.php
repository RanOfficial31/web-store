...
<body class="bg-gray-200 l:flex">
    ...
    <div class="l:w-full lg:ml-64 px-6 py-8">
        ...
        <div class=" mb-8">
            <a href="product-add"><span class="tracking-wider text-white bg-sky-500 px-4 py-2 text-md rounded leading-loose mx-2 font-semibold
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn text-white bg-sky-500 hover:bg-sky-400 shadow-[3px_3px_3px_#b1b1b1] m-1 transition ease-in-out delay-0 hover:-translate-1 hover:scale-110 duration-300"
                                            href="product-detail?r4n=<?php echo $data['id']; ?>">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
