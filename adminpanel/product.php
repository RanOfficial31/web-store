...
<!-- MAIN NAVBAR START -->
    ...
    <!-- Barra lateral -->
    <div id="sidebar" data-aos="fade-right" data-aos-duration="3000"
        class="lg:block hidden bg-white w-64 h-screen fixed rounded-none border-none fixed shadow-[3px_3px_5px_#b1b1b1] z-40">
        <!-- Items -->
        <div class="p-4 space-y-4">
            <a href="index.php" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 text-gray-500 font-semibold text-lg
            ...
            <a href="category.php" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 text-gray-500 font-semibold text-lg
                hover:border-r-[6px] hover:text-sky-500 border-sky-500 transition ease-in-out delay-0 hover:-translate-x-1 hover:scale-100 duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-tags font-semibold" viewBox="0 0 16 16">
                    <path d="M3 2v4.586l7 7L14.586 9l-7-7H3zM2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2z"/>
                    <path d="M5.5 5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1v5.086z"/>
                </svg>
                <span class="-mr-1 font-medium">Category</span>
            </a>
            <a href="product.php" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 text-gray-500 font-semibold text-lg
                hover:border-r-[6px] border-sky-500 transition ease-in-out delay-0 hover:-translate-x-1 hover:scale-100 duration-300
                <?= $page == "product.php"? 'border-r-[6px] border-sky-500 text-sky-500':'';?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" 
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $data['nama_categori']; ?></td>
