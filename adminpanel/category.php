...
<body class="bg-gray-200 l:flex">
	<!-- MAIN NAVBAR START -->
	<nav class="bg-white border-b border-gray-300 sticky top-0 z-40 shadow-[3px_3px_5px_#b1b1b1]" data-aos="fade-down"
	...
	<div id="sidebar" data-aos="fade-right" data-aos-duration="3000"
		...
		<div class="p-4 space-y-4">
			...
			<a href="index.php" aria-label="dashboard"
				class="relative px-4 py-3 flex items-center space-x-4 text-gray-500 font-semibold text-lg
				hover:border-r-[6px] border-sky-500 <?= $page == "category.php" ? 'border-r-[6px] border-sky-500 text-sky-500' : ''; ?> transition ease-in-out delay-0 hover:-translate-x-1 hover:scale-100 duration-300">
				<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
			...
			<a href="product.php" aria-label="dashboard"
				class="relative px-4 py-3 flex items-center space-x-4 text-gray-500 font-semibold text-lg
				hover:border-r-[6px] hover:text-sky-500 border-sky-500 transition ease-in-out delay-0 hover:-translate-x-1 hover:scale-100 duration-300">
				<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
