...
?>
                <div class="alert alert-danger alert-dismissible fade show animate__animated animate__bounceInDown animate__delay-1s sticky-top" role="alert">
...
<div class="min-h-screen flex items-center justify-center">
        <div
            class="max-w-xl w-full p-6 bg-white rounded-lg shadow-lg animate__animated animate__bounceIn animate__delay-1s">
            <div class="flex justify-end text-xl font-semibold text-red-600"><a href="product.php" class="hover:text-orange-500"><i class="bi bi-x-lg"></i></a></div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-4">
                    ...
                    <input type="text" id="nama" name="nama" value="<?php echo $data['nama'];?>"
                        class="w-full px-4 py-2 border-2 border-gray-400 rounded-lg"
                        required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select id="categori" name="categori"
                        class="border-2 border-gray-400 text-sm text-gray-500 rounded-lg block w-full px-4 py-2" required>
                        <option selected class="bg-gray-500 text-white" value="<?php echo $data['categori_id'];?>"><?php echo $data['nama_categori'];?></option>
                        <?php 
                            while($dataCategori=mysqli_fetch_array($queryCategori)) {
                        ?>
                        <option value="<?php echo $dataCategori['id']; ?>"><?php echo $dataCategori['nama']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="file" id="foto" name="foto" class="w-full px-4 py-2 mt-2 rounded-lg border-2 border-gray-400">
                </div>

                <div class="mb-4">
                    <label for="detail" class="block mb-2 text-sm text-gray-600">Detail :</label>
                    <textarea id="detail" name="detail" rows="4"
                    class="bg-gray-100 block w-full text-md drop-shadow-lg rounded-lg border-2 border-gray-400 
                    focus:ring-orange-500 focus:border-orange-500"><?php echo $data['detail']; ?>
                </textarea>
                </div>

                <div class="mb-4">
                    <label for="ketersediaan_stok" class="block mb-2 text-sm text-gray-600">Product Availability Status :</label>
                ...
                <button type="submit" name="simpan"
                    class="w-full bg-sky-500 text-white py-2 rounded-lg mx-auto block shadow-[5px_5px_5px_#b1b1b1] hover:shadow-none bg-sky-600
                    focus:outline-none mb-4">Save</button>
            </form>
            <div class="text-center mt-2">
                <p class="text-md"><a href="product.php" class="text-sky-500 hover:text-sky-400">cancel</a></p>
            </div>
        </div>
    </div>
    <!-- MAIN CONTENT END -->
